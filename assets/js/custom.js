define(["jquery", "toggles", "marionette", "jquery-cookies", "jquery-migrate", "jquery-sparkline", "modenizr", "retina", "bootstrap","moment"], function () {
    ...
    var start = function() {
        jQuery(document).ready(function () {
            ...
            if (c) {
                jQuery('head').append('<link id="skinswitch" rel="stylesheet" href="assets/css/style.' + c + '.css" />');
            }

            // Changing Font
            var fnt = jQuery.cookie('change-font');
            if (fnt) {
                jQuery('head').append('<link id="fontswitch" rel="stylesheet" href="assets/css/font.' + fnt + '.css" />');
            }
